...
import { openModal } from "Store/actions/layout_actions";
...
function About({ t }) {
  ...
  const openModalAction = (tab) =>
    dispatch(openModal("about_modal", { title: tab?.title, desc: tab?.desc }));
          ...
          <Row>
            ...
            <Col md={7} className="right-ab">
              <div className="desc-box">
                <StyledHeadline data-text={t("home.about.h1")}>
                  {t("home.about.h1")}
                </StyledHeadline>
                <p>{t("home.about.p1")}</p>
              </div>
              <div className="desc-box">
                <StyledHeadline data-text={t("home.about.h2")}>
                  {t("home.about.h2")}
                </StyledHeadline>
                <p>{t("home.about.p2")}</p>
