                    ...
                    <Row>
                        <Col md={6} xs={12}>
                            <div className="item">
                                ...
                                <span className="value">{singleCarData?.brand?.name[activeLang]}</span>
                            </div>
                            <div className="item">
                                <span className="label">{t('carDetails.model')}:</span>
                                <span className="value">{singleCarData?.model?.modelType[activeLang]}</span>
                            </div>
                            <div className="item">
                            ...
                            <div className="item">
                                ...
                                <span className="value">{singleCarData?.fuelType?.typeName[activeLang]}</span>
                            </div>
                            <div className="item">
                                <span className="label">{t('carDetails.gearType')}:</span>
                                <span className="value">{singleCarData?.gearType?.typeName[activeLang]}</span>
                            </div>
                        </Col>
                        <Col md={6} xs={12}>
                            <div className="item">
                                <span className="label">{t('carDetails.bodyType')}:</span>
                                <span className="value">{singleCarData?.bodyType?.typeName[activeLang]}</span>
                            </div>
                            <div className="item">
                            ...
                            <div className="item">
                                <span className="label">{t('carDetails.seeringWheelSide')}:</span>
                                <span className="value">{singleCarData?.steeringWheelSide}</span>
                            </div>
                            <div className="item">
                                <span className="label">{t('carDetails.color')}:</span>
                                <span className="value">{singleCarData?.color?.name[activeLang]}</span>
                            </div>
                        </Col>
                    </Row>
                </div>
                                        ...
                                        <Tab key={idx} eventKey={tab.eventKey} title={tab.title}>
                                            <div className="carr-summary">
                                                <Row>
                                                    <Col md={6}>
                                                        {
                                                            dataToRender.length && dataToRender?.map((item, idx) => {
                                                                return (
                                                                    <div className="item">
                                                                        <span className="label">{t('carDetails.name')}:</span>
                                                                        <span className="value">
                                                                            {
                                                                                activeTab === 'multimedia' ?
                                                                                    (activeLang === 'tr' ? item?.typeName?.tr : item?.typeName?.en)
                                                                                    :
                                                                                    (activeLang === 'tr' ? item?.featureName?.tr : item?.featureName?.en)
                                                                            }
                                                                        </span>
                                                                    </div>
                                                                )
